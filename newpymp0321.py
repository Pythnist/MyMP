...
'''
This is an attempt to write the MyMP (Pygame Music Player) program.
This is my very first program and project if you find any bug or you 
want to upgrade the code feel free 
Started coding at 1/7/2012 and finished at 23/8/2012.
...
class Player:
    def __init__(self,master):
        ...
        self.b3 = Button(master, text='About MyMP', command=self.about, font=(FONT,SIZE))
    ...
    def about(self):
        ...
        self.play_music(path.join(FIRSTDIR,'hexes.mp3'))

        self.msg = 0
        self.opened_file = open(path.join(FIRSTDIR,'info.txt'),'r').readlines()

        self.top = Toplevel(self.master)
        self.top.title('About MyMP')
